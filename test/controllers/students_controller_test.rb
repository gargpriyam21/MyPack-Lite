...
class StudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not create student with null values" do
    post student_url, params: { student: {} }
    assert_response :error
  end

  test "should not create student with invalid email" do
    post students_url, params: { student: { date_of_birth: "45/54/3234", email: "random#ran", major: "RNDM", name: "something", password: "random", phone_number: "12453", student_id: 5 } }
    assert_response :error
  end

  test "should not create student with invalid date of birth" do
    post students_url, params: { student: { date_of_birth: "45/54/3234", email: "random#ran", major: "RNDM", name: "something", password: "random", phone_number: "12453", student_id: 5 } }
    assert_response :error
  end

  test "should not create student with invalid phone_number" do
    post students_url, params: { student: { date_of_birth: "45/54/3234", email: "random#ran", major: "RNDM", name: "something", password: "random", phone_number: "12453", student_id: 5 } }
    assert_response :error
  end
