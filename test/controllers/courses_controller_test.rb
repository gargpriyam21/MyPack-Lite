...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not create curse with negative capacity" do
  ...
  test "should not create curse with null name only" do
  ...
  test "should not create curse with null description only" do
  ...
  test "should not create curse with null course code only" do
  ...
  test "should not create curse with null room only" do
  ...
  test "should not create curse with invalid course_code" do
  ...
  test "should not create curse with weekday1 equal to weekday2" do
    post courses_url, params: { course: { capacity: @course.capacity, course_code: @course.course_code, description: @course.description, end_time: @course.end_time, instructor_name: @course.instructor_name, name: @course.name, room: @course.room, start_time: @course.start_time, status: @course.status, students_enrolled: @course.students_enrolled, students_waitlisted: @course.students_waitlisted, waitlist_capacity: @course.waitlist_capacity, weekday1: "MON", weekday2: "MON" } }
    assert_response :error
  end

  test "should not create curse with end_time less that end_time only" do
  ...
  test "should not create curse with negative waitlist_capacity only" do
