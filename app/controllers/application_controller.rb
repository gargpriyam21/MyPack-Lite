class ApplicationController < ActionController::Base
  ...
  def check_permissions?(user_type, action)
    @actions = {"instructor" => ['create_course', 'delete_course',  'update_course', 'edit_course','show_course','show_instructor_course', 'create_enrollment','delete_enrollment','edit_enrollment','update_enrollment','show_enrollment','show_instructor','show_student'],
                "admin" => ['create_course', 'delete_course',  'update_course', 'edit_course','show_course','show_instructor_course', 'create_enrollment','delete_enrollment','edit_enrollment','update_enrollment','show_enrollment','show_instructor','show_instructor_student',
                            'edit_student','create_student','delete_student','update_student','create_instructor','delete_instructor','update_instructor','edit_instructor',],
