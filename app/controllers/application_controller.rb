class ApplicationController < ActionController::Base
  ...
  def check_permissions?(user_role, action)
    ...
    @actions = {
      "instructor" => ['create_course', 'create_enrollment', 'delete_course', 'delete_enrollment', 'edit_course', 'edit_enrollment', 'show_all_student', 'show_course', 'show_enrollment', 'show_instructor', 'show_instructor_course', 'show_instructor_student', 'show_instructor_students_enrolled', 'show_student', 'showinstructorcourses', 'unenroll_course', 'update_course', 'update_enrollment', 'view_course'],
      "student" => ['drop_course', 'enroll_course', 'show_course', 'show_enrolled_course', 'view_course'],
